...
module Jekyll
  ...
  class SitemapGenerator < Generator
    ...
    # Returns a string containing the the XML entries for non blog pages.
    #
    #  +site+ is the global Site object.
    def generate_nonBlogFiles()
      pageArray = ['index', 'elearning', 'webapps', 'websites', 'blog']
      result = ""
